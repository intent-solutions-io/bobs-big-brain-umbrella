...
|---|---|
| **Date** | 2026-07-09 |
| **Applies to** | the Bob's Big Brain stack — Compiler (`intentional-cognition-os` on npm), Registrar (`@qmd-team-intent-kb/*` packages), `bobs-big-brain-plugin`, and this umbrella |
