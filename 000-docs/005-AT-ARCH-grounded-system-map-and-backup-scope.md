...
_Snapshot 2026-08-07T10:42:34Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 245M | candidates 17608 · curated_memories 17446 (active 10253 / superseded 6501 / deprecated 681 / archived 11) · audit_events 24678 (v1 872 / v2 23806) · memory_links 302 |
...
**curated_memories by category:** reference 16221 · pattern 595 · troubleshooting 355 · architecture 118 · decision 80 · convention 60 · onboarding 17.

**Backup:** latest `teamkb-full-20260807T104142Z.tar.zst.age` (2026-08-07T10:42:27Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->
