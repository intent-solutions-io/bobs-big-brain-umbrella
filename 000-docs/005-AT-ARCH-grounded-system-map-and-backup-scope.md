...
_Snapshot 2026-08-17T02:33:23Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._
...
| `brain/.ico/state.db` — ICO compile | 35M | — |
| `brain/raw/` — corpus (source of truth) | 157M | 16926 files |
| `brain/wiki/` — compiled markdown | 105M | 18697 files |
...
**Backup:** latest `teamkb-full-20260817T022442Z.tar.zst.age` (2026-08-17T02:26:17Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->
