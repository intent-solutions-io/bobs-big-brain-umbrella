...
_Snapshot 2026-08-02T10:33:23Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 245M | candidates 17563 · curated_memories 17401 (active 10208 / superseded 6501 / deprecated 681 / archived 11) · audit_events 24629 (v1 872 / v2 23757) · memory_links 302 |
| `brain/.ico/state.db` — ICO compile | 35M | — |
| `brain/raw/` — corpus (source of truth) | 156M | 16866 files |
| `brain/wiki/` — compiled markdown | 104M | 18637 files |
| `brain/audit/` — ICO receipts | 105M | — |
| `brain/spool/` — ICO→INTKB handoff | 3.0M | — |
| `kb-export/` — derived | 80M | — |
| `qmd-index/` — derived | 527M | — |
| **`~/.teamkb` total** | **3.6G** | — |

**curated_memories by category:** reference 16221 · pattern 586 · troubleshooting 345 · architecture 111 · decision 68 · convention 53 · onboarding 17.

**Backup:** latest `teamkb-full-20260802T103242Z.tar.zst.age` (2026-08-02T10:33:16Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->
