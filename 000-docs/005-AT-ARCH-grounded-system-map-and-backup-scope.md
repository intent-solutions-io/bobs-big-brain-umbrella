...
_Snapshot 2026-09-24T23:20:02Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 245M | candidates 18082 · curated_memories 17915 (active 10721 / superseded 6502 / deprecated 681 / archived 11) · audit_events 25197 (v1 872 / v2 24325) · memory_links 302 |
| `brain/.ico/state.db` — ICO compile | 121M | — |
| `brain/raw/` — corpus (source of truth) | 165M | 17621 files |
| `brain/wiki/` — compiled markdown | 111M | 19362 files |
| `brain/audit/` — ICO receipts | 109M | — |
| `spool/` — shared ICO→INTKB intake | 60M | — |
| `kb-export/` — derived | 82M | — |
| `qmd-index/` — derived | 601M | — |
| **`~/.teamkb` total** | **5.5G** | — |

**curated_memories by category:** reference 16250 · pattern 695 · troubleshooting 500 · architecture 162 · convention 146 · decision 139 · onboarding 23.

**Backup:** latest `teamkb-full-20260924T103234Z.tar.zst.age` (2026-09-24T10:33:45Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->
