...
_Snapshot 2026-07-29T22:44:58Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 245M | candidates 17539 · curated_memories 17377 (active 10184 / superseded 6501 / deprecated 681 / archived 11) · audit_events 24602 (v1 872 / v2 23730) · memory_links 302 |
...
**curated_memories by category:** reference 16221 · pattern 586 · troubleshooting 341 · architecture 103 · decision 62 · convention 47 · onboarding 17.

**Backup:** latest `teamkb-full-20260729T103242Z.tar.zst.age` (2026-07-29T10:33:15Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->
